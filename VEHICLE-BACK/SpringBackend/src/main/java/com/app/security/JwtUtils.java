...
public class JwtUtils {
	...
	// will be invoked by User controller : SignIn , upon successful authentication
	public String generateJwtToken(Authentication authentication,Long id) {
		...
		return Jwts.builder()								 // JWTs : a Factory class , used to create JWT tokens
				...
				.setId(id.toString())// setting subject part of the token(typically user name/email)
	...
	public Claims validateJwtToken(String jwtToken) {
		...
		Claims claims = Jwts.parserBuilder()
				.setSigningKey(key).build() 			// Sets the signing key used to verify JWT digital signature.
	...
	public boolean isTokenValid(String token, UserDetails userDetails) {
		final String username = getUserNameFromJwtToken(validateJwtToken(token));
